 ...
 */
final class Version20241115101417 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id SERIAL NOT NULL, product_cat_id INT DEFAULT NULL, stock_id INT DEFAULT NULL, name VARCHAR(25) NOT NULL, image VARCHAR(255) DEFAULT NULL, unitary_price DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE stock (id SERIAL NOT NULL, quantity INT NOT NULL, PRIMARY KEY(id))');
